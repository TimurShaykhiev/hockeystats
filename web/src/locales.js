  ...
  messages: {
    ...
    ru: {
      ...
      statNames: {
        ...
        ppGoals: 'PP Goals',
        ppGoalsShort: 'PPG',
        ppOpportunities: 'PP Opportunities',
        ppOpportunitiesShort: 'PPO',
        shGoalsAgainst: 'SH Goals Against',
        shGoalsAgainstShort: 'SHGA',
        shOpportunities: 'SH Opportunities',
        shOpportunitiesShort: 'SHO',
        faceOffWins: 'Faceoff Wins',
        faceOffWinsShort: 'FOW',
        faceOffTaken: 'Faceoff Taken',
        faceOffTakenShort: 'FOT',
        blocked: 'Blocked',
        blockedShort: 'BL',
        takeaways: 'Takeaways',
        takeawaysShort: 'TAw',
