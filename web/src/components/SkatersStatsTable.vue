...
import {floatToStr, toiToStr, getSeasonName} from 'Components/utils';
  ...
  computed: {
    ...
    paginationText() {
      return {
        ...
        rowsPerPage: this.$t('pagination.rowsPerPage'),
        ofText: this.$t('pagination.ofText'),
        allText: this.$t('pagination.allText')
      };
    },
